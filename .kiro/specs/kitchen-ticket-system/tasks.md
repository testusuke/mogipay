...
- [x] 1.1 キッチンチケット用のデータベーステーブルを作成する
...
- [x] 1.2 データベーステーブルの制約とインデックスを検証する
  - 外部キー制約が正しく機能することを確認
...
- [x] 3.1 アクティブなチケット一覧を取得する機能を実装する
...
- [x] 6.3 セット商品のチケット表示コンポーネントを実装する
...
- [x] 7.1 チケット一覧取得の API クライアントを実装する
